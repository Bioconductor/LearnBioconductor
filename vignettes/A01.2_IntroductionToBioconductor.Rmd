...
2. Select fastq files from the File --> Open menu. Files are in
   `/home/ubuntu/fastq
...
fls <- dir("/home/ubuntu/fastq", pattern="*fastq", full=TRUE)
...
```{r ShortRead-qa-all}
load("/home/ubuntu/fastq/qa_all.Rda")
...
4. Use File -> Load from File menu to load a bam file, e.g.,
   `/home/ubuntu/bam/SRR1039508_sorted.bam`
...
```
mkdir -p ~/igv/genomes
cp /home/ubuntu/hg19_alias.tab ~/igv/genomes/
igv
```
...
fl <- "/home/ubuntu/bam/SRR1039508_sorted.bam"
