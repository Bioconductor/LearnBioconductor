...
* Identify the risk factors(genes) for prostrate cancer based on gene expression
data 
...
![Summarized Experiment](inst/figure/sum_expt.png)
...
For **Supervised learning**, we will use cervical count data from the Biocoductor
package, MLSeq. This data set contains expressions of 714 miRNA's of human 
samples. There are 29 tumor and 29 non-tumor cervical samples. For learning 
purposes, we can treat these as two separate groups and run various 
...
fused so that there are n-2 clusters. This algorithm proceeds iteratively until 
...
![knn_figure](inst/figure/knn.png)
